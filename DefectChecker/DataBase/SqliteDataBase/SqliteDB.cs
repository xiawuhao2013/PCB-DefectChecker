...
namespace DefectChecker.DataBase.SqliteDataBase
{
    class SqliteDB
    {
        ...
        private void CreateDateBaseAndTable()
        {
            ...
            string sqlCmd = "CREATE TABLE IF NOT EXISTS " + _tableName + "(Time TIMESTAMP default (datetime('now', 'localtime')), Product varchar(50), Batch varchar(50), Board varchar(50), Side varchar(50), Shot varchar(50), Defect varchar(50), MarkInfo varchar(4096));";
            SqliteCMD(sqlCmd);
        }
